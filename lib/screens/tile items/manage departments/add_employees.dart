...
class AddEmployeeToDepartment extends StatefulWidget {
  final String departmentID;
  const AddEmployeeToDepartment({super.key, required this.departmentID});

  @override
  State<AddEmployeeToDepartment> createState() => _AddEmployeeToDepartmentState();
}

class _AddEmployeeToDepartmentState extends State<AddEmployeeToDepartment> {
              ...
              SizedBox(
                  ...
                  itemBuilder: (context, index) {
                    return ListTile(
                      onTap:  () {
                        uid = items[index]['uid'];
                         AddAlertBox(context, items[index]['username'], widget.departmentID, uid);
                      },
                      leading: AspectRatio(
                        aspectRatio: 1 / 1,
                        child: ClipRRect(
  ...
  dynamic AddAlertBox(BuildContext context, String username, String department, String userID) {
  return showDialog(context: context, builder: (BuildContext context){
    return AlertDialog(
      title: Text("Add $username to $department department",
      ...
      actions: [
        ...
        Center(
          child: MaterialButton(onPressed: () async {
            ...
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => AddEmployeeToDepartment(departmentID: widget.departmentID,)));
          },
          shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(50)
          ),
